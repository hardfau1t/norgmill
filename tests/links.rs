...
fn test_link_with_url_target() {
    ...
    assert_eq!(html, "<body><div><p><a href=\"https://example.com\"><title>https://example.com</title></a></p></div></body>");
}

#[test]
fn test_link_with_description() {
    let html = test_link_rendering("{https://example.com}[Example Website]", None);
    assert_eq!(html, "<body><div><p><a href=\"https://example.com\"><title>Example Website</title></a></p></div></body>");
}

#[test]
fn test_link_with_heading_target_no_file_path() {
    let html = test_link_rendering("{* Test Heading}", None);
    assert_eq!(html, "<body><div><p><a href=\"#Test_Heading_h1\"><title>#Test_Heading_h1</title></a></p></div></body>");
}
...
fn test_link_with_footnote_target_no_file_path() {
    ...
    assert_eq!(
        html,
        "<body><div><p><a href=\"#footnote1_f\"><title>#footnote1_f</title></a></p></div></body>"
    );
}
...
fn test_link_with_definition_target_no_file_path() {
    ...
    assert_eq!(
        html,
        "<body><div><p><a href=\"#term_d\"><title>#term_d</title></a></p></div></body>"
    );
}
...
fn test_link_to_heading_with_file_path_system_root() {
    ...
    assert_eq!(html, "<body><div><p><a href=\"/view/root/docs/file.norg#TargetHeading_h2\"><title>/view/root/docs/file.norg#TargetHeading_h2</title></a></p></div></body>");
}
...
fn test_link_to_heading_with_file_path_home() {
    let norg_input = "{:~/docs/file.norg:** TargetHeading}";
    let html = test_link_rendering(norg_input, None);
    assert_eq!(html, "<body><div><p><a href=\"/view/home/docs/file.norg#TargetHeading_h2\"><title>/view/home/docs/file.norg#TargetHeading_h2</title></a></p></div></body>");
}
...
fn test_link_to_heading_with_file_path_workspace() {
    let norg_input = "{:$/docs/file.norg:** TargetHeading}";
    let html = test_link_rendering(norg_input, None);
    assert_eq!(html, "<body><div><p><a href=\"/view/current/docs/file.norg#TargetHeading_h2\"><title>/view/current/docs/file.norg#TargetHeading_h2</title></a></p></div></body>");
}
...
fn test_link_to_heading_with_file_path_different_workspace() {
    ...
    let html = test_link_rendering(norg_input, None);
    assert_eq!(html, "<body><div><p><a href=\"/view/workspace/other_ws/docs/file#TargetHeading_h2\"><title>/view/workspace/other_ws/docs/file#TargetHeading_h2</title></a></p></div></body>");
}
...
fn test_link_with_path_target_system_root() {
    ...
    let html = test_link_rendering(norg_input, None);
    assert_eq!(html, "<body><div><p><a href=\"/view/root/path/to/file.txt?raw=1\"><title>/view/root/path/to/file.txt?raw=1</title></a></p></div></body>");
}
...
fn test_link_with_path_target_home() {
    ...
    let html = test_link_rendering(norg_input, None);
    assert_eq!(html, "<body><div><p><a href=\"/view/home/path/to/file#heading_h1\"><title>description</title></a></p></div></body>");
}
...
fn test_link_with_path_target_relative() {
    ...
    let html = test_link_rendering(norg_input, None);
    assert_eq!(html, "<body><div><p><a href=\"relative/path#heading2_h2\"><title>relative/path#heading2_h2</title></a></p></div></body>");
}
...
fn test_link_with_empty_targets() {
    ...
    assert_eq!(
        html,
        "<body><div><p><a href=\"#\"><title>#</title></a></p></div></body>"
    );
}
...
fn test_link_with_line_number_target_with_file() {
    ...
    assert_eq!(
        html,
        "<body><div><p><a href=\"file#\"><title>file#</title></a></p></div></body>"
    );
}
